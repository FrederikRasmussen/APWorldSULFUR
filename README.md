...
- Make equipment (accessories, armour, boots, helmet) purchaseable or printable in the Church if acquired through multi world
- Randomise laser sight items so their colour is fully random (for all valid colours)
- Add purchaseable multi world items to shopkeeps
